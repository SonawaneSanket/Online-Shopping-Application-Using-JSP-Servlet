...
<h3>Update security Question</h3>
 ...
 <input class="input-style" type="text" name="newAnswer" placeholder="Enter Your Updated answer here" required="required">
<hr>
<h3>Enter Password (For Security)</h3>
 <input class="input-style" type="password" name="password" placeholder="Enter Your password(for security purpose.)" required="required">
