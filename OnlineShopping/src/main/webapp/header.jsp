...
<div class="topnav sticky">
	...
	<element>
	<center>
		<h2 class='two'>Welcome to DevMarT</h2>
	</center>
	</element>
	<h2>
		<a href="">
	...
	<a href="home.jsp">Home <i class="fa-solid fa-house-user"></i></a> <a
		href="myCart.jsp">My Cart <i class="fa-solid fa-cart-plus"></i></a> <a
